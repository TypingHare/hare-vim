...
-- Find old files in the project scope. Old files refer to the files that were
-- opened and recorded before by Neovim.
...
end, { desc = 'Find Files with Same Extension', silent = true })
...
-- Go to the reference (implementation) under the cursor.

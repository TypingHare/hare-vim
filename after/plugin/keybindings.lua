...
vim.keymap.set(
    ...
    '<leader>br',
    ':e!<CR>',
    { desc = 'Refresh Buffer', silent = true }
)

-- Format the current file. It uses Conform if it exists; otherwise, use
-- Neovim's built-in LSP formatting instead.

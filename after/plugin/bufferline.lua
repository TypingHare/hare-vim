...
-- Select the next buffer in cycle.
vim.keymap.set(
    'n',
    '<Tab>',
...
-- Select the previous buffer in cycle.
vim.keymap.set(
    'n',
    '<S-Tab>',
...
-- Save and close the current buffer; select the previous buffer in cycle if
-- it exists.
vim.keymap.set('n', '<leader>bd', function()
    -- Save the current buffer if it has a name and is modifiable and not
    -- readonly
    ...
    -- Select the previous buffer in cycle if it exists
